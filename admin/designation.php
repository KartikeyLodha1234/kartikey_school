        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card" style="border-left: 4px solid #2563eb;">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="stat-icon" style="background:#2563eb;"><i class="fas fa-tags"></i></div>
                </div>
                <div class="stat-sub">All designations</div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="stat-card" style="border-left: 4px solid #10b981;">
                ...
                <div class="stat-sub">Active designations</div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="stat-card" style="border-left: 4px solid #f59e0b;">
                ...
                <div class="stat-sub">Total staff with designations</div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="stat-card" style="border-left: 4px solid #ef4444;">
                ...
                <div class="stat-sub">Inactive designations</div>
            </div>
        </div>
    </div>
